 ...
 *
 *  1. The digest is taken over extracted, normalized text where the text can be
...
/**
 * Readable text from an HTML document, normalized so that whitespace and
 ...
 *
 * Modeled on `probe()` in lib/evidence-verification.mjs, and for the same
